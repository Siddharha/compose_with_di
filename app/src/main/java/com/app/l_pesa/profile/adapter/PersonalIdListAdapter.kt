...
class PersonalIdListAdapter (val context: Context, private val listIdType: ArrayList<ResDashboard.PersonalIdType>, private val dialogOBJ: Dialog,private val callBack: ICallBackClickPersonalId) : androidx.recyclerview.widget.RecyclerView.Adapter<androidx.recyclerview.widget.RecyclerView.ViewHolder>() {
