...
class ProfileEduLvlAdapter (val context: Context, private val listIdType: ArrayList<ResUserAdditionalInfoDropdowns.Data.EducationalLevel>, private val dialogOBJ: Dialog, private val callBack: ICallBackClickMoreAbout) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
