...
class ArcSeekBar @JvmOverloads constructor(
    ...
    private val thumb: Drawable = a?.getDrawable(R.styleable.ArcSeekBar_thumb) ?: resources.getDrawable(R.drawable.progress_thumb)
    ...
    private var progressPaint: Paint = makeProgressPaint(
            color = a.useOrDefault(resources.getColor(R.color.colorAquaDeep)) { getColor(R.styleable.ArcSeekBar_progressColor, it) },
            width = progressWidth
    )
