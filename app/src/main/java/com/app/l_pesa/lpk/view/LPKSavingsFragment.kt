...
class LPKSavingsFragment : Fragment(), TabLayout.OnTabSelectedListener {
    ...
    private fun initUI()
    {
        ...
        val adapter = SavingsTabAdapter(childFragmentManager, tabLayout!!.tabCount)
